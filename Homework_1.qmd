...
* Collect and process raw data related to the outcome of interest (sometimes in partnership with data engineers)
...
This section demonstrates my ability to perform the R tasks indicated in Homework 2. To begin, I will create an object, $y$, which contains the kernel density estimate for Petal Width in the $iris$ dataset. 
